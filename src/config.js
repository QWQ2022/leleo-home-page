const config = {
	...
	metaData: {
		title: '清枫的个人主页🎉',
		description: '欢迎来到清枫的Website',
		keywords: 'QingFeng,qwq2022,清枫,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "https://avatars.githubusercontent.com/u/94837700", // 头像
	welcometitle: "Hi, I'm QingFeng", // 标题
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				...
				"url": "https://imgapi.cn/api.php?fl=dongman&gs=images",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "pic",
			"datainfo": {
				...
				"url": "https://imgapi.cn/api.php?fl=dongman&gs=images&zd=mobile"  //同理，随机移动端壁纸："url":"https://t.mwm.moe/mp"
			}
		}
